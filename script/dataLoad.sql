...
BEGIN
    FOR i IN 1..60 LOOP
        ...
        INSERT INTO product (category_id, barcode, name, description, brand, unit_measure, weight)
        VALUES (
            v_cat_id,
            'MOT' || LPAD(i::TEXT, 8, '0'),
            v_product_names[i],
    ...
    LOOP
        ...
        FOR i IN 1..120 LOOP
            ...
            INSERT INTO sales_transaction (
                store_id, employee_id, sale_date, total_amount, payment_method, status, observation
            )
            VALUES (
                v_store.store_id,
                ...
                v_payment_methods[1 + floor(random() * array_length(v_payment_methods, 1))::INTEGER],
